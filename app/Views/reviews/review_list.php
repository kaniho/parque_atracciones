												...
												<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-125px"><a href="<?= base_url('reviews?sort=nombre_atraccion&order=' . ($sort == 'nombre_atraccion' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Atracción</a></th>
															<th class="min-w-125px"><a href="<?= base_url('reviews?sort=nombre_usuario&order=' . ($sort == 'nombre_usuario' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Usuario</a></th>
															<th class="min-w-125px"><a href="<?= base_url('reviews?sort=calificacion&order=' . ($sort == 'calificacion' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Calificación</a></th>
															<th class="min-w-125px"><a href="<?= base_url('reviews?sort=comentario&order=' . ($sort == 'comentario' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Comentario</a></th>
															<th class="min-w-125px"><a href="<?= base_url('reviews?sort=fecha_creacion&order=' . ($sort == 'fecha_creacion' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Fecha</a></th>
