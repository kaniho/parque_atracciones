				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="post d-flex flex-column-fluid" id="kt_post">
						...
						<div id="kt_content_container" class="container-xxl">
                            ...
                            <!--end::Navbar-->
                            <!--begin::Basic info-->
                            <div class="card mb-5 mb-xl-10"><!-- SEGUNDA PARTE DEL SETTINGS DE LA CUENTA -->
                                <!--begin::Card header-->
                                ...
                                <div id="kt_account_profile_details" class="collapse show">
                                    <!--begin::Form-->
                                    <form id="kt_account_profile_details_form" class="form" action="<?= isset($user) ? base_url('users/save/') . $user['id'] : base_url('users/save') ?>" method="post">
                                        <!--begin::Card body-->
                                        <div class="card-body border-top p-9">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 fv-row">
                                                            <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" value="<?= isset($user) ? esc($user['nombre_usuario']) : '' ?>" />
                                                        </div>
                                                        <!--end::Col-->                                                        
                                                    </div>
                                                    <!--end::Row-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <input type="email" name="email" id="email" class="form-control form-control-lg form-control-solid" placeholder="Company name" value="<?= isset($user) ? esc($user['email']) : '' ?>" />
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                                    <span class="required" for="password">Contraseña</span>
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i>
                                                </label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="password" name="password" id="password" class="form-control form-control-lg form-control-solid" placeholder="Phone number" value="" />
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->                                         
                            ...
                            <div class="card mb-5 mb-xl-10"> <!-- TERCERA PARTE DEL SETTINGS DE LA CUENTA PARTE PARA CAMBIAR EL CORREO Y LA CONTRASEÑA -->
                                <!--begin::Card header-->
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-10">
                                            ...
                                            <div id="kt_signin_password_button" class="ms-auto">
                                                <button class="btn btn-light btn-active-light-primary">Restablecer contraseña</button>
                                            </div>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Password-->                                      
                            ...
                            <div class="card"> <!--  PARTE DE ELIMINAR LA CUENTA POR LO PRONTO LO DEJAMOS -->
                                <!--begin::Card header-->
                                    ...
                                    <form id="kt_account_deactivate_form" class="form">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                                                ...
                                                <div class="d-flex flex-stack flex-grow-1">
                                                    ...
                                                    <div class="fw-bold">
                                                        ...
                                                        <div class="fs-6 text-gray-700">Para mayor seguridad, es necesario que confirmes tu correo electrónico o número de teléfono cuando restablezcas tu contraseña de yousignr.
                                                        <br />
                                            ...
                                            <div class="form-check form-check-solid fv-row">
                                                ...
                                                <label class="form-check-label fw-bold ps-2 fs-6" for="deactivate">Confirmo la desactivación de mi cuenta</label>
                                            </div>
                                            <!--end::Form input row-->
                                        </div>
                                        <!--end::Card body-->
                                        <!--begin::Card footer-->
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                                            <button id="kt_account_deactivate_account_submit" type="submit" class="btn btn-danger fw-bold">Desactivar cuenta</button>
                                        </div>
                                        <!--end::Card footer-->
                                    </form>
                                    <!--end::Form-->
