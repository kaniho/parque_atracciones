												...
												<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-125px"><a href="<?= base_url('horarios?sort=nombre_horario&order=' . ($sort == 'nombre_horario' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Nombre</a></th>
															<th class="min-w-125px"><a href="<?= base_url('horarios?sort=hora_inicio&order=' . ($sort == 'hora_inicio' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Horario de inicio</a></th>
															<th class="min-w-125px"><a href="<?= base_url('horarios?sort=hora_fin&order=' . ($sort == 'hora_fin' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Horario de finalización</a></th>
															<?php if ($session->get('id_rol') == 1): ?>
