											...
											<?php if (!empty($tickets) && is_array($tickets)): ?>
												...
												<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=id_reserva&order=' . ($sort == 'id_reserva' && $order == 'asc' ? 'desc' : 'asc')) ?>">Reserva</a></th>
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=codigo_ticket&order=' . ($sort == 'codigo_ticket' && $order == 'asc' ? 'desc' : 'asc')) ?>">Código Ticket</a></th>
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=fecha_creacion&order=' . ($sort == 'fecha_creacion' && $order == 'asc' ? 'desc' : 'asc')) ?>">Fecha de Creación</a></th>
															...
															<tr> <!-- PRUEBA -->
																...
																<td class="text-end">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		...
																		<div class="menu-item px-3">		
																		<?php if ($ticket['archivado']): ?>
																			<a href="<?= base_url('tickets/restore/' . $ticket['id'])  ?>" onclick="return confirm('¿Estás seguro de que deseas restaurar este ticket?');"
																				class="menu-link px-3" data-kt-users-table-filter="delete_row">Desarchivar <i class="fa-solid fa-trash ms-4"></i>
																			</a><!-- AQUI PONEMOS EL LINK PARA RESTAURAR EL TICKET -->
																		<?php else: ?>
																			<a href="<?= base_url('tickets/delete/' . $ticket['id'])  ?>" onclick="return confirm('¿Estás seguro de que deseas archivar este ticket?');"
																				class="menu-link px-3" data-kt-users-table-filter="delete_row">Archivar <i class="fa-solid fa-trash ms-4"></i>
																			</a><!-- AQUI PONEMOS EL LINK PARA ELIMINAR EL TICKET -->
																		<?php endif; ?>
																		</div>
																		<!--end::Menu item-->
																	</div>
												...
												<div class="mt-4">
													<div class="d-flex justify-content-between align-items-center">
														...
														<div >													
															<?= $pager->only(['codigoTicket', 'fechaCreacion', 'estado', 'ticketArchivado'])->links("default", "custom_pagination") ?> <!-- Usa la plantila predeterminada -->
														</div>
													</div>													
												</div>
											<?php else: ?>
