												...
												<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
													...
													<thead>
														...
														<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
															...
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=id_reserva&order=' . ($sort == 'id_reserva' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Reserva</a></th>
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=codigo_ticket&order=' . ($sort == 'codigo_ticket' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Código Ticket</a></th>
															<th class="min-w-125px"><a href="<?= base_url('tickets?sort=fecha_creacion&order=' . ($sort == 'fecha_creacion' && $order == 'asc' ? 'desc' : 'asc') . '&perPage=' . $perPage) ?>">Fecha de Creación</a></th>
