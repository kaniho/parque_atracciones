				...
				<div id="kt_header" class="header align-items-stretch">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
							...
							<!-- FIN DE LA PARTE DEL BOTÓN DE CERRAR SESIÓN -->
						</div>
						<!--end::Wrapper-->
					</div>
					<!--end::Container-->
														...
														<tr>													
															...
															<td class="d-flex align-items-center position-relative">
																...
																<div class="d-flex flex-column"> <!-- PARTE DEL LOS NOMBRES DE LOS USUARIOS -->
																	...
																	<span><?= esc($user['email']) ?></span> <!-- PARTE DEL FOREACH DONDE PILLA EL CORREO -->
																</div>
																<!--begin::User details-->
															</td>
															<!--end::User=-->
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<div class="menu-item px-3">
																		...
																		<?php else: ?>
																			<a href="<?= base_url('users/delete/' . $user['id'])  ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?');"
